...
public class TaquinApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        TaquinController taquinController = fxmlLoader.getController();
        Taquin taquin = new Taquin(4);
        taquinController.setScene(scene);
        taquinController.setModel(taquin);
        taquin.setController(taquinController);
        taquin.startGame();
